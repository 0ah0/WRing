...
If any error is found, lexical errors can be generated by Lexical Analyzer and Parser is the producer of both syntax and semantic errors. \todo{I don't understand this}
...
\begin{figure}[ht]
	...
	The Lexical Analyzer supplies with the generated tokens to the Parser.
	Once it has enough tokens, the Parser starts with parsing procedure and continues to request new tokens from the Lexical Analyzer.
	Any lexical error is generated by the Lexical Anaylzer whereas syntax and semantic errors are produced by the Parser.
