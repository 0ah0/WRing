...
The main contributions of RDF-Doctor (the title of output tool of this study) are:
\begin{enumerate}
...
\begin{itemize}
	...
	\item {\textbf{Chapter \ref{ch:evaluation}:}} shows the "Evaluation" where the approach is tested and the results are discussed .
