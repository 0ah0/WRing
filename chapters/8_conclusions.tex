...
Utilizing the ANTLR framework, the used grammar should be adopted in such a way that parsers in different programming languages can be generated.%, as it has been mentioned in Chapter \ref{ch:related}.    
