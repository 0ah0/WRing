...
\cline{1-4}
Sn. & Catergory & Position & Sample &  \\ \cline{1-4}
1 & \multirow{3}{*}{Bad string escape
} & Literal & \textcolor{red}{"a\textbackslash zb" } &  \\ \cline{1-1} \cline{3-4}
2 &  & Literal & \textcolor{red}{"\textbackslash uWXYZ"}  &  \\ \cline{1-1} \cline{3-4}
3 &  & Literal &  \textcolor{red}{"\textbackslash U0000WXYZ"} &  \\  \cline{1-4}
\end{tabular}
