...
The main workflow used in RDF-Doctor is illustrated in Figure \ref{Fig:Approach} and Figure \ref{Fig:Architecture}.
...
\item \textbf {Healing a part of encountered syntax errors}:%%%%%%%%%%%%%%%%%%%%
 { Figure} \ref{Fig:Architecture} shows this feature as one of the processing components. %%%%%%%%%%%%%%%%%%%%
